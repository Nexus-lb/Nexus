...
const FeaturedPost: React.FC<FeaturedPostProps> = ({ title, summary, image, date, readTime }) => {
  return (
    <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-blue-600 to-blue-800 text-white">
      ...
      <div className="relative p-8 md:p-12">
        ...
        <p className="text-lg text-white/90 mb-6 max-w-2xl">{summary}</p>
